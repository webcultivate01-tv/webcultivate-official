  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-center mb-6">
        Build fast, secure, and scalable websites using modern web technologies
        and frameworks.
      </p>
      ...
      <div className="flex gap-3 relative z-10">
        ...
        <Link
          to="/contact"
          className="flex-1 text-center px-4 py-3 bg-gradient-to-r from-secondary to-primary text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-secondary/25 transition-all duration-300 cursor-pointer"
          style={{ pointerEvents: 'auto' }}
        >
          Get Quote
        </Link>
