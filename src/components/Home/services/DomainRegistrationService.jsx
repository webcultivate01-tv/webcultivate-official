    ...
    >
      ...
      <div className="flex gap-3 relative z-10">
        <Link
          ...
          className="flex-1 text-center px-4 py-3 border-2 border-orange-600 text-orange-600 dark:text-orange-400 font-semibold rounded-xl hover:bg-orange-600 hover:text-white transition-all duration-300 cursor-pointer"
        ...
        <Link
          to="/contact"
          className="flex-1 text-center px-4 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-orange-600/25 transition-all duration-300 cursor-pointer"
          style={{ pointerEvents: 'auto' }}
        >
          Get Quote
        </Link>
