  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-center mb-6">
        Create stunning, responsive, and user-friendly websites that perfectly represent your brand.
      </p>
      ...
      <Link
        to="/contact"
        className="block w-full text-center px-6 py-3 bg-gradient-to-r from-primary to-secondary text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 group-hover:scale-105"
      >
        Get Quote
      </Link>
    </motion.div>
